...
#    Updated: 2025/02/12 13:07:58 by aoutumur         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = main.c draw_map.c load_sprites.c move_player.c read_map.c validate_map.c init_game.c flood_fill.c error_exit.c
OBJS = $(SRCS:.c=.o)
